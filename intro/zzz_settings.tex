...
\newcommand{\utpres}{
  \renewcommand*\titlelogos{\centering\includegraphics[scale=.6]{pics/logos/logos_ut}}
  \logo{\includegraphics[height=.34cm]{pics/logos/utk.png}}
  \setbeamercolor{structure}{fg=UT}
}

\newcommand{\ornlpres}{
  \renewcommand*\titlelogos{\centering\includegraphics[scale=.6]{pics/logos/logos_ornl}}
  \logo{\includegraphics[height=.34cm]{pics/logos/ornl.jpg}}
  \setbeamercolor{structure}{fg=ORNL}
}

\newcommand{\allpres}{
  \renewcommand*\titlelogos{\centering\includegraphics[scale=.6]{pics/logos/logos_all}}
  \logo{\begin{tabular}{r}\includegraphics[height=.34cm]{pics/logos/utk.png} \\ \includegraphics[height=.34cm]{../common/pics/logos/ornl.jpg}\end{tabular}}
  \setbeamercolor{structure}{fg=UT}
}
